...
curl -q -X POST -H 'Content-Type: application/json' -d '{"name": "api"}' --user devops:liveproject http://localhost:3000/api/v1/users/devops/tokens > response.json
